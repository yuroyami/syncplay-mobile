...
import app.DataStoreKeys.PREF_REMEMBER_INFO
import app.R
import app.home.settings.Setting
import app.home.settings.SettingCategory
import app.home.settings.SettingType
import java.util.Locale

object MySettings {

    fun HomeActivity.mySettings(): List<SettingCategory> {
            ...
            SettingCategory(
                ...
                settingList = listOf(
                    ...
                    Setting(
                        ...
                        key = "shared_playlist_media_directories_setting",
