            ...
            ConstraintLayout(
                ...
                Card(
                    ...
                    LazyVerticalGrid(
                        ...
                        itemsIndexed(dirs.value.toList()) { index, item ->
                            ...
                            Box {
                                ...
                                Column(modifier = Modifier
                                    ...
                                    Icon(
                                        ...
                                        tint = Paletting.OLD_SP_YELLOW, modifier = Modifier.size(64.dp)
                                    )
                ...
                FlowRow(
                    ...
                    Button(
                        ...
                        Icon(imageVector = Icons.Filled.ClearAll, "", tint = Color.Black)
                    ...
                    Button(
                        ...
                        Icon(imageVector = Icons.Filled.CreateNewFolder, "", tint = Color.Black)
                        Spacer(modifier = Modifier.width(8.dp))
                        Text(stringResource(R.string.media_directories_add_folder), fontSize = 14.sp, color = Color.Black)
                    }
                    ...
                    Button(
                        ...
                        Spacer(modifier = Modifier.width(8.dp))
                        Text(stringResource(R.string.media_directories_save), fontSize = 14.sp, color = Color.Black)
                    }
                }
            }
        }
