        ...
        return RoomPopup(
            ...
            ConstraintLayout(
                ...
                Column(modifier = Modifier.constrainAs(credits) {
                    ...
                    Text(color = MaterialTheme.colorScheme.primary, text = "• Version: 0.11.0", fontSize = 11.sp, maxLines = 1)
                    Text(color = MaterialTheme.colorScheme.primary, text = "• Developed by: Reddnek", fontSize = 11.sp, maxLines = 1)
                    Text(
                ...
                Image(
                    ...
                    modifier = Modifier
                        .clickable(
                            ...
                            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.github.com/Reddnek/syncplay-android/releases"))
