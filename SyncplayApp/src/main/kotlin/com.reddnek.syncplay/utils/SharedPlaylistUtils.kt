...
object SharedPlaylistUtils {
    ...
    fun RoomActivity.saveFolderPathAsMediaDirectory(uri: Uri) {
        val list = com.reddnek.syncplay.controllers.activity.DirectoriesActivity.getFolderList(
            p.gson,
            com.reddnek.syncplay.controllers.activity.DirectoriesActivity.prefKey,
            this
        )
        list.add(uri.toString())
        com.reddnek.syncplay.controllers.activity.DirectoriesActivity.writeFolderList(
            list,
            p.gson,
            com.reddnek.syncplay.controllers.activity.DirectoriesActivity.prefKey,
            this
