...
/** This class has code for VLC 4 which currently doesn't work in SwiftUI/Compose */
...
//                return@UIKitViewController vc.also {
//                    initialize()
//                }
//            },
//            interactive = false,
...
//                if (index >= 0) {
//                    vlcPlayer!!
//                    //todo vlcPlayer?.selectTrack(viewmodel?.media?.subtitleTracks?.get(index)?.index.toString())
//                } else if (index == -1) {
//                    //todo vlcPlayer?.unselectTrackType(Track.Type.Text)
//                }
//
...
//        vlcPlayer?.delegate = VLClistener()
//    }
//
//
...
//    }
//
//    inner class VLClistener : NSObject(), VLCMediaPlayerDelegateProtocol {
//
...
//            if (hasMedia()) {
//                val isPlaying = true
//                viewmodel?.isNowPlaying?.value = VLCMediaPlayerState.VLCMediaPlayerStatePlaying == newState //Just to inform UI
//
