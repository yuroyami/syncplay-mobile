...
expect suspend fun SyncplayViewmodel.addFolderToPlaylist(uri: String)
...
expect fun SyncplayViewmodel.savePlaylistLocally(toFolderUri: String)
...
expect fun SyncplayViewmodel.loadPlaylistLocally(fromUri: String, alsoShuffle: Boolean)
