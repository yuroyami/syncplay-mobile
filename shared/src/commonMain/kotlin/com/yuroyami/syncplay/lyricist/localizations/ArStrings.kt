...
val ArStrings = object : Strings {
    ...
    override val settingsCategLanguage = "اللغة"
    override val settingsCategSyncing = "المزامنة"
    override val settingsCategExoplayer = "Exoplayer"
    override val settingsCategNetwork = "الشبكة"
    override val settingsCategAdvanced = "متقدم"
    ...
    override val settingEraseShortcutsTitle = "حذف كل الاختصارات"
    override val settingEraseShortcutsSummary = "يحذف هذا الخيار جميع الاختصارات التي أضفتها من الشاشة الرئيسية التي تسمح لك بحفظ إعدادات جاهزة"
    override val settingEraseShortcutsDialog = "هل تريد حقاً حذف جميع اختصارات الإعداد السريع التي أضفتها مسبقاً ؟"
    ...
    override val uiSettingMpvInterpolationTitle = "تحوير تردد و معدل الإطارات"
    override val uiSettingMpvInterpolationSummary = "تقليل التقطع عن طريق تمكين تحوير معدل الإطارات. تذكر أن هذا سيتم تطبيقه فقط إذا تم تعيين خيار مزامنة الفيديو على أحد أوضاع 'display'، وإلا فسيتم تجاهله بصمت. قد لا يعمل هذا بشكل جيد في بعض الحالات."
    override val uiSettingMpvVidsyncTitle = "وضع مزامنة الفيديو"
    override val uiSettingMpvVidsyncSummary = "تحكم في كيفية مزامنة mpv للفيديو، سواء مع الصوت (الافتراضي، مُوصى به) أو مع جهاز العرض نفسه."
    override val uiSettingMpvProfileTitle = "الإعداد المسبق للتقديم (الملف الشخصي)"
    override val uiSettingMpvProfileSummary = "يكوّن قدرات mpv وفقًا لأحد الإعدادات المسبقة للملف الشخصي المضمنة. الافتراضي هو 'fast' لأنه مناسب للهواتف. يمكن أن يكون استخدام 'low-latency' مفيدًا عند بث البيانات من مصادر مباشرة."
