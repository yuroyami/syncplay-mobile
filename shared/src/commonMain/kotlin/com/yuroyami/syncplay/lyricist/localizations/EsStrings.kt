...
val EsStrings = object : Strings {
    ...
    override val roomAttemptingTls = "Intentando conexión segura"
    override val roomTlsSupported = "Conexión segura establecida (TLS)"
    override val roomTlsNotSupported = "El servidor no admite TLS"
    ...
    override val settingEraseShortcutsTitle = "Eliminar todos los accesos directos de inicio"
    override val settingEraseShortcutsSummary = "Esto eliminará todos los accesos directos de inicio de 'ejecución rápida' que creaste a través de la pantalla principal para guardar tus configuraciones de habitación."
    override val settingEraseShortcutsDialog = "¿Realmente deseas borrar todos los accesos directos existentes?"
    ...
    override val uiSettingMpvInterpolationSummary = "Reduzca el temblor habilitando la interpolación de fotogramas. Tenga en cuenta que esto solo se aplicará si la opción de sincronización de video está configurada en uno de los modos 'display', de lo contrario se ignorará silenciosamente. Esto puede no funcionar bien en algunos casos."
    override val uiSettingMpvVidsyncTitle = "Video sync mode"
    override val uiSettingMpvVidsyncSummary = "Controla cómo mpv sincroniza el video, ya sea con el audio (predeterminado, recomendado) o con la pantalla misma."
    override val uiSettingMpvProfileTitle = "Rendering preset (profile)"
    override val uiSettingMpvProfileSummary = "Configura las capacidades de mpv según uno de los preajustes de perfil integrados. El predeterminado es 'fast' ya que es adecuado para teléfonos. El uso de 'low-latency' puede ser útil al transmitir desde fuentes en vivo."
