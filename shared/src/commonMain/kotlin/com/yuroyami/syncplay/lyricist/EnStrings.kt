...
val EnStrings = object : Strings {
    ...
    override val roomPingConnected = { p0: String -> "Connected - PING: %s ms".format(p0) }
    override val roomPingDisconnected = "Disconnected"
    override val roomOverflowSub = "Load Subtitle File…"
    override val roomOverflowMsghistory = "Message History"
    override val roomOverflowSettings = "Settings"
    ...
    override val roomConnectedToServer = "Connected to the server."
    ...
    override val roomDetailsCurrentRoom = { p0: String -> "Current Room: %s".format(p0) }
    ...
    override val roomButtonDescAdd = "Add Media File"
    ...
    override val settingsCategGeneral = "General Settings"
    override val settingsCategPlayer = "Player Settings"
    override val settingsCategRoom = "Room Settings"
    override val settingsCategVideo = "Video Settings"
    override val settingsCategMisc = "Miscellaneous"
    ...
    override val settingTlsSummary = "If a server supports TLS secure connection, Syncplay Android will attempt to connect to it through TLS. (Not available yet)"
    override val settingTlsTitle = "Use Secure Connection (TLSv1.3) [Available Soon]"
