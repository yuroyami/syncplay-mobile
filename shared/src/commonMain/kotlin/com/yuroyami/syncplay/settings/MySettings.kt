...
//                    ),
    ...
    val sgROOM
        get() = mutableListOf(
            ...
            val allSettings = settingsROOM
            settingsROOM.addAll(additionalPlayerRoomSettings)
            allSettings.populate(it)
        }



    /** =============== */
    var additionalPlayerRoomSettings =  listOf<Pair<Setting<out Any>, String>>()
