...
class ConnectFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.connectJoinButton.setOnClickListener {
            ...
            val serverPort = (binding.spMenuAutocomplete.text).toString().substringAfter("syncplay.pl:").toInt()
    ...
    override fun onResume() {
        ...
        if (PreferenceManager.getDefaultSharedPreferences(requireContext()).getBoolean("save_info", true)) {
